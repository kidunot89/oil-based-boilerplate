<?php
/**
 * Registers WordPress core options not loaded by Settings API to be loaded in the WPGraphQL schema.
 *
 * @package oil-based-boilerplate
 */

if ( ! function_exists( 'patch_whitelist_options' ) ) :
	/**
	 * The "graphql_init" callback
	 */
		...
		$whitelist_options = array(
			'discussion' => array(
				...
				'avatar_rating'                => array(
					'show_in_graphql' => true,
					'show_in_rest'    => array(
						'schema' => array( 'enum' => array( 'G', 'PG', 'R', 'X' ) ),
					),
					'type'            => 'string',
			...
			'media'      => array(
				'thumbnail_size_w'              => array(
					'show_in_graphql' => true,
					'show_in_rest'    => array( 'name' => 'thumbnail_size_width' ),
					'type'            => 'integer',
				...
				'thumbnail_size_h'              => array(
					'show_in_rest' => array( 'name' => 'thumbnail_size_height' ),
					'type'         => 'integer',
				...
				'medium_size_w'                 => array(
					'show_in_graphql' => array( 'name' => 'medium_size_width' ),
					'type'            => 'integer',
				...
				'medium_size_h'                 => array(
					'show_in_graphql' => true,
					'show_in_rest'    => array( 'name' => 'medium_size_height' ),
					'type'            => 'integer',
				...
				'large_size_w'                  => array(
					'show_in_graphql' => true,
					'show_in_rest'    => array( 'name' => 'large_size_width' ),
					'type'            => 'integer',
				...
				'large_size_h'                  => array(
					'show_in_graphql' => true,
					'show_in_rest'    => array( 'name' => 'large_size_height' ),
					'type'            => 'integer',
			...
			'permalink'  => array(
				'permalink_structure' => array(
					'show_in_graphql' => true,
					'show_in_rest'    => array( 'name' => 'structure' ),
					'type'            => 'string',
			...
			'reading'    => array(
				...
				'show_on_front'       => array(
					'show_in_graphql' => true,
					'show_in_rest'    => array(
						'schema' => array( 'enum' => array( 'posts', 'page' ) ),
					),
					'type'            => 'string',
